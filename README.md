...
With this program, I wanted to solve the date classification by putting the date in front of the filename, so that the file explorer (in my case: Nautilus, because Linux > Mac > Windows ) will show the earlier photo first. With this, one may resort its photos into albums quickly.

Requirements:
- Image Magick
- \*NIX (because Windows suck!)
